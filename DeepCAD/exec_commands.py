...
# cmd = "nohup python pc2cad.py --exec train --exp_name pc2cad_LRscheduler_8096 --batch_size 590 \
...
#         --exp_name pc2cad_8192 --ckpt latest --n_points 8096 -g 0"
#         --load_modular_ckpt --pce_exp_name pcEncRandNoise100New --pce_ckpt latest \
#         --ae_exp_name pretrained --ae_ckpt ckpt_epoch1000"


cmd = "tensorboard --logdir proj_log/pc2cad/pc2cad_LRscheduler_8096/log --host 0.0.0.0"
