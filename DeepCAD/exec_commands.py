...
cmd = "python pc2cad.py --exec train --exp_name pc2cad_MSE_test --batch_size 175 \
...
# cmd = "python pc2cad.py --exec test --mode acc --num_worker 8  \
#         --exp_name pc2cad_contDiffNums --ckpt latest --n_points 8192 -g 0 "
...
#          --z_path proj_log/pce/pcEncNoNoise/results/pcEncodings/ckpt_epoch20_num4096/00195139_2024-05-0000-23-49-26/00195139.h5"
