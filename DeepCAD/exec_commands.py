...
# cmd = "python pc2cad.py --exec train --exp_name pcEncRandNoise100New \
#     --batch_size 150 --num_workers 1 --nr_epochs 100 --noise -g 0"


cmd = "python pc2cad.py --exec train --exp_name pc2cad_Exp --num_workers 8 --batch_size 180 \
    --nr_epochs 100 --noise -g 0"

# cmd = "python pcEnc.py --exec inf --mode rec --pc_root evaluation/eval_pc_cad_images/source \
...
# cmd = "tensorboard --logdir proj_log/pce/pcEncRandNoise100New/log --host 0.0.0.0"
