...
cmd = "nohup python pc2cad.py --exec train --exp_name pc2cad_Exp200 --num_workers 8 --batch_size 175 \
    --nr_epochs 200 --noise -g 1 &"
...
# cmd = "tensorboard --logdir proj_log/pc2cad/pc2cad_test100/log --host 0.0.0.0"
