...
class Bottleneck(nn.Module):
    def __init__(self, cfg):
        ...
        self.bottleneck = nn.Sequential(nn.Linear(cfg.d_model, cfg.dim_z), nn.Tanh())
...
class CADTransformer(nn.Module):
    ...
    def forward(self, commands_enc, args_enc, z=None, encode_mode=False):
        commands_enc_, args_enc_ = _make_seq_first(
            commands_enc, args_enc
        )  # Possibly None, None
